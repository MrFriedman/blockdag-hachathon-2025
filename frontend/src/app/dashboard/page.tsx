              ...
              <CardContent>
                <div className="space-y-4">
                  {upcomingAppointments.map((appointment) => (
                    <div key={appointment.id} className="p-4 bg-gradient-card rounded-lg border border-primary/10 hover-scale">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium">Blood work results added</p>
                      <p className="text-xs text-muted-foreground">Dr. Jennifer Wong • 2 hours ago</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">Dr. Sarah Chen • 1 day ago</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-accent rounded-full mt-2"></div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium">Annual checkup scheduled</p>
                      <p className="text-xs text-muted-foreground">System • 3 days ago</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                {recentRecords.map((record) => (
                  <div key={record.id} className="p-4 bg-gradient-card rounded-lg border border-primary/10 hover-scale">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col gap-2">
                        <Badge
                          ...
                          className={record.status === 'completed' ? 'bg-medical-success' : ''}
                        >
                          {record.status}
                        </Badge>
                        <Button variant="outline" size="sm">
